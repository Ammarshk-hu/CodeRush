...
export default function Timeline() {
  ...
  return (
    <section
      id="timeline"
      className="py-20 md:py-32 relative z-10 overflow-hidden bg-[#fafafa]"
    >
      {/* Background Decorative Elements */}
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-[10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-[#ccff00]/10 blur-[120px]" />
        <div className="absolute bottom-[10%] right-[-10%] w-[50%] h-[50%] rounded-full bg-[#ccff00]/5 blur-[150px]" />
      </div>
          ...
          {activeTab === 'timeline' && (
            ...
            >
              <div className="relative w-[3000px] h-[750px] mx-auto mt-10">
                ...
                >
                  <img
                    src="/running_breakthrough.png"
                    alt="Breakthrough User"
                    className="w-full h-full object-contain drop-shadow-xl"
                  />
                </motion.div>
                ...
                {scheduleEvents.map((evt, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Event Content */}
                      <div
                        className={`w-full ${isTop ? 'mb-20' : 'mt-20'
                          } text-center`}
                      >
          ...
          {activeTab === 'submission' && (
            ...
            >
              ...
              <div className="neon-card p-8 sm:p-12 rounded-3xl relative overflow-hidden">
                <div className="absolute top-0 right-0 w-64 h-64 bg-[#ccff00]/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3 pointer-events-none" />
              ...
              <div className="p-6 rounded-2xl bg-amber-50 border-2 border-amber-400 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-red-800 mt-2 leading-relaxed max-w-2xl font-medium">
                    Submissions close precisely at{' '}
                    <strong className="font-extrabold text-red-950 bg-red-100 px-2 py-0.5 rounded">
                      22 August 2026, 09:00 PM IST
                    </strong>
                    . Late submissions or broken demo/Figma links will lead to
                    disqualification. Ensure your team submits early!
                  </p>
                </div>
              </div>
